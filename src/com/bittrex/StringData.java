...
public class StringData {
	...
	public String getMarketHistory(String currencyPair) {
		return this.getPublicData("/public/getmarkethistory", "?market=" + currencyPair);
	}
	...
	public String createBuyOrder(String currencyPair, double quantity, BigDecimal rate) {
		return this.getAccountData("/market/buylimit",
				"&market=" + currencyPair + "&quantity=" + quantity + "&rate=" + rate);
	}
	...
	public String createSellOrder(String currencyPair, double quantity, double rate) {
		return this.getAccountData("/market/selllimit",
				"&market=" + currencyPair + "&quantity=" + quantity + "&rate=" + rate);
	}
